...
namespace Fdsmlfr
{
    public partial class FormCriatura : Form
    {
        ...
        public FormCriatura()
        {
            ...
            comboHabitad.Items.AddRange(listaHabitads.ToArray());
            ...
            comboHabitad.SelectedIndex = 0;
        }

        private void ButtonCrear_Click(object sender, EventArgs e)
        {
            List<IHabitad> habitatsSeleccionados = new List<IHabitad>();
            foreach (CheckBox checkBox in checkedListHabitad.Controls)
            {
                if (checkBox.Checked)
                {
                    habitatsSeleccionados.Add((IHabitad)checkBox.Tag);
                }
            }
        ...
        { 
            ...
            foreach (var Criatura in  listCriatura) 
            {
                ...
                //Aca esta el que vamos a modificar
